...
export const introText =
  "השאלון נועד לסייע לך לזהות את החוזקות וההזדמנויות המרכזיות בצוות שלך, דרך חמישה מאפיינים של צוות אפקטיבי. עבור כל היגד, סמן את רמת ההסכמה שלך בסולם של 1 עד 5: 1 = אינך מסכים, 5 = מסכים בהחלט.";
